...
class Lesson1 {
     ...
     *     <li><b>String[] args</b>: Parametrii metodei main, care sunt argumentele de linie de comandă; este încă devreme să știi ce înseamnă asta.</li>
     * </ul>
     */
    public static void main(String[] args) {
        System.out.println("Apasa triunghiul ▶ verde din stanga si vezi ce se intampla ! 😄");
        ...
        // Dupa cum ai inteles System.out.println afiseaza in consola ceea ce ii dai intre parantezele rotunde

        // E timpul pentru practica deschide clasa Lesson2
    }
}
